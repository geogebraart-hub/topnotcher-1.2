        ...
        <main className="study-main">
          ...
          <section className="study-question-card">
            <div className="study-question-card-head">
              ...
              <button type="button" className="secondary-btn compact study-edit-question-btn" onClick={()=>onEditQuestion?.(q)} aria-label="Edit current question">
                <Pencil size={15}/> Edit Question
              </button>
            </div>
