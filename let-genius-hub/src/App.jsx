...
function ExamRunner({session,close,setMockScores,setMockHistory,setSessions,setQuestionStats}) {
  ...
  useEffect(()=>{
    localStorage.setItem(storageKey,JSON.stringify({index,answers,submitted,remaining,result,deadline}));
